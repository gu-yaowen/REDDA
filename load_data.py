...
def load():
    drug_drug = pd.read_csv('./interactions/drug_drug.csv')
    protein_protein = pd.read_csv('./interactions/protein_protein.csv')
    gene_gene = pd.read_csv('./interactions/gene_gene.csv')
    pathway_pathway = pd.read_csv('./interactions/pathway_pathway.csv')
    disease_disease = pd.read_csv('./interactions/disease_disease.csv')
    drug_protein = pd.read_csv('./associations/drug_protein.csv')
    protein_gene = pd.read_csv('./associations/protein_gene.csv')
    gene_pathway = pd.read_csv('./associations/gene_pathway.csv')
    pathway_disease = pd.read_csv('./associations/pathway_disease.csv')
